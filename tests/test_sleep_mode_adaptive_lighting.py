...
async def test_sleep_start_records_on_state_cancels_focus_and_disables_main_al(
    ...
    hass.states.async_set("input_boolean.bedroom_sleep_restore_adaptive_lighting", "off")
    ...
    assert hass.states.get("input_boolean.bedroom_sleep_restore_adaptive_lighting").state == "on"
...
async def test_sleep_start_records_off_state_when_main_al_was_already_off(
    ...
    hass.states.async_set("input_boolean.bedroom_sleep_restore_adaptive_lighting", "on")
    ...
    assert hass.states.get("input_boolean.bedroom_sleep_restore_adaptive_lighting").state == "off"
    assert hass.states.get("switch.adaptive_lighting_adaptive_lighting").state == "off"
