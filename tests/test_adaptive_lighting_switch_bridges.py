...
async def test_turning_main_switch_on_during_sleep_does_not_reapply_al(
    ...
    """Sleep mode should keep temporary control even if the main AL switch changes."""
...
async def test_turning_main_switch_on_during_focus_does_not_reapply_al(
    ...
    """Focus mode should keep temporary control even if the main AL switch changes."""
